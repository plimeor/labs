...
| ------- | ------- | ----- |
| [`@plimeor/command-kit`](packages/command-kit) | Bun-first command declaration runtime for repo-local CLI and agent tools. It handles command groups, arg binding, Standard Schema validation, help metadata, and JSON result envelopes. | TypeScript, Bun |
