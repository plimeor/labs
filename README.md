...
| ------- | ------- | ----- |
| [`@plimeor/code-wiki`](packages/code-wiki) | Code wiki CLI. It registers Git projects by portable remote URL and ref, scans managed clones into versioned Markdown wikis with deterministic routing indexes, and queries current or historical snapshots through Codex. | TypeScript, Bun |
