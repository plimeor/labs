...
## 40. Progress ledger update — 2026-06-10 — TextKit AppKit view lifecycle

本节追加 `50-textkit-appkit-view-lifecycle-report.md` 的 ledger 状态。`21` 的原始 CP-1 synthesis 结论仍成立：CP-1 core side complete；Apple half 仍 release / delivery gated；CP-1 whole-exit 未退出。

### 40.1 Axis matrix after doc 50

| Axis | Verdict |
|---|---|
| core deterministic（groups 1+5） | **go**（unchanged） |
| multi-target compile | **go**（unchanged） |
| zero-cloud-symbol boundary | **go**（unchanged after doc 50 audit） |
| binding（B4） | **approved boundary / partially release-gated** — unchanged after doc 49 |
| TextKit（group 3 runtime） | **partial mechanism floor closed** — real AppKit `NSView` / `NSTextView` insert/move/remove lifecycle floor closed; product integration and UIKit runtime remain open |
| iCloud Drive（B14） | **approved default transport WITH compromise constraints** — unchanged after doc 49 |
| layout / retention | **compromise** — unchanged after doc 49 |
| cross-target execution CI | **hosted native/wasm/iOS-sim closed; Android execution open** — unchanged after doc 49 |
| **CP-1 whole-exit** | **未退出 (NOT exited)** |

### 40.2 Open-gate checklist after doc 50

| Gate | Status | Evidence pointer |
|---|---|---|
| real AppKit `NSView` / `NSTextView` insert/move/remove lifecycle | closed as mechanism floor | `50 §4.1` |
| product AppKit view hierarchy integration | open / not run | `50 §5` |
| UIKit / `UITextView` view lifecycle runtime | open / not run | `50 §4.2`, `50 §5` |
| product responder-chain routing | open / not run | `49 §5`, `50 §5` |
| menu command routing and keyboard shortcuts beyond probed events | open / not run | `49 §5` |
| multi-view focus and keyboard routing | open / not run | `49 §5`, `50 §5` |
| `UITextView` keyboard/input runtime behavior | open / not run | `49 §4.2`, `49 §5` |
| real `anchor-core::dispatch` integration for keyboard intents and patches | open / not run | `49 §5`, `50 §5` |
| product accessibility mapping / VoiceOver runtime | open / not run | `47 §5`, `48 §5`, `50 §5` |
| cross-view / cross-block accessibility expression | open / not run | `47 §5` |
| external volume | open / not run | `46 §6` |
| security-scoped bookmark restoration | open / not run | `46 §6` |
| Finder move UI surface | open / not run | `46 §6` |
...
## 41. Progress ledger update — 2026-06-10 — TextKit first-responder keyboard routing

本节追加 `51-textkit-first-responder-keyboard-routing-report.md` 的 ledger 状态。`21` 的原始 CP-1 synthesis 结论仍成立：CP-1 core side complete；Apple half 仍 release / delivery gated；CP-1 whole-exit 未退出。

### 41.1 Axis matrix after doc 51

| Axis | Verdict |
|---|---|
| core deterministic（groups 1+5） | **go**（unchanged） |
| multi-target compile | **go**（unchanged） |
| zero-cloud-symbol boundary | **go**（unchanged after doc 51 audit） |
| binding（B4） | **approved boundary / partially release-gated** — unchanged after doc 50 |
| TextKit（group 3 runtime） | **partial mechanism floor closed** — macOS AppKit first-responder keyboard routing floor closed; product menu/focus lifecycle and UIKit runtime remain open |
| iCloud Drive（B14） | **approved default transport WITH compromise constraints** — unchanged after doc 50 |
| layout / retention | **compromise** — unchanged after doc 50 |
| cross-target execution CI | **hosted native/wasm/iOS-sim closed; Android execution open** — unchanged after doc 50 |
| **CP-1 whole-exit** | **未退出 (NOT exited)** |

### 41.2 Open-gate checklist after doc 51

| Gate | Status | Evidence pointer |
|---|---|---|
| macOS AppKit first-responder keyboard routing across two `NSTextView` surfaces | closed as mechanism floor | `51 §4.1` |
| product menu command routing | open / not run | `51 §5` |
| product focus lifecycle across real windows / scroll views / split views | open / not run | `51 §5` |
| UIKit / `UITextView` keyboard routing runtime | open / not run | `51 §4.2`, `51 §5` |
| real `anchor-core::dispatch` integration for keyboard intents and patches | open / not run | `49 §5`, `50 §5`, `51 §5` |
| product AppKit view hierarchy integration | open / not run | `50 §5` |
| UIKit / `UITextView` view lifecycle runtime | open / not run | `50 §4.2`, `50 §5` |
| product accessibility mapping / VoiceOver runtime | open / not run | `47 §5`, `48 §5`, `50 §5` |
| cross-view / cross-block accessibility expression | open / not run | `47 §5` |
...
## 42. Progress ledger update — 2026-06-10 — TextKit accessibility hierarchy

本节追加 `52-textkit-accessibility-hierarchy-report.md` 的 ledger 状态。`21` 的原始 CP-1 synthesis 结论仍成立：CP-1 core side complete；Apple half 仍 release / delivery gated；CP-1 whole-exit 未退出。

### 42.1 Axis matrix after doc 52

| Axis | Verdict |
|---|---|
| core deterministic（groups 1+5） | **go**（unchanged） |
| multi-target compile | **go**（unchanged） |
| zero-cloud-symbol boundary | **go**（unchanged after doc 52 audit） |
| binding（B4） | **approved boundary / partially release-gated** — unchanged after doc 51 |
| TextKit（group 3 runtime） | **partial mechanism floor closed** — macOS AppKit accessibility hierarchy across two text surfaces closed; product accessibility mapping, VoiceOver/UI runtime, cross-block native selection, and UIKit runtime remain open |
| iCloud Drive（B14） | **approved default transport WITH compromise constraints** — unchanged after doc 51 |
| layout / retention | **compromise** — unchanged after doc 51 |
| cross-target execution CI | **hosted native/wasm/iOS-sim closed; Android execution open** — unchanged after doc 51 |
| **CP-1 whole-exit** | **未退出 (NOT exited)** |

### 42.2 Open-gate checklist after doc 52

| Gate | Status | Evidence pointer |
|---|---|---|
| macOS AppKit accessibility hierarchy across two text surfaces | closed as mechanism floor | `52 §4.1` |
| product accessibility mapping | open / not run | `52 §5` |
| VoiceOver / Accessibility Inspector runtime | open / not run | `52 §5` |
| polished cross-block continuous native text selection | open / not run | `52 §5` |
| UIKit / `UITextView` accessibility runtime | open / not run | `52 §4.2`, `52 §5` |
| product menu command routing | open / not run | `51 §5` |
| product focus lifecycle across real windows / scroll views / split views | open / not run | `51 §5` |
| UIKit / `UITextView` keyboard routing runtime | open / not run | `51 §4.2`, `51 §5` |
| real `anchor-core::dispatch` integration for keyboard intents and patches | open / not run | `49 §5`, `50 §5`, `51 §5`, `52 §5` |
| product AppKit view hierarchy integration | open / not run | `50 §5` |
| UIKit / `UITextView` view lifecycle runtime | open / not run | `50 §4.2`, `50 §5` |
| external volume | open / not run | `46 §6` |
| security-scoped bookmark restoration | open / not run | `46 §6` |
...
## 43. Progress ledger update — 2026-06-10 — TextKit menu command routing

本节追加 `53-textkit-menu-command-routing-report.md` 的 ledger 状态。`21` 的原始 CP-1 synthesis 结论仍成立：CP-1 core side complete；Apple half 仍 release / delivery gated；CP-1 whole-exit 未退出。

### 43.1 Axis matrix after doc 53

| Axis | Verdict |
|---|---|
| core deterministic（groups 1+5） | **go**（unchanged） |
| multi-target compile | **go**（unchanged） |
| zero-cloud-symbol boundary | **go**（unchanged after doc 53 audit） |
| binding（B4） | **approved boundary / partially release-gated** — unchanged after doc 52 |
| TextKit（group 3 runtime） | **partial mechanism floor closed** — macOS AppKit selector / menu item sender routing for split / merge-backward intents closed; product menu system, product focus lifecycle, product responder-chain undo, UIKit runtime, and dispatch integration remain open |
| iCloud Drive（B14） | **approved default transport WITH compromise constraints** — unchanged after doc 52 |
| layout / retention | **compromise** — unchanged after doc 52 |
| cross-target execution CI | **hosted native/wasm/iOS-sim closed; Android execution open** — unchanged after doc 52 |
| **CP-1 whole-exit** | **未退出 (NOT exited)** |

### 43.2 Open-gate checklist after doc 53

| Gate | Status | Evidence pointer |
|---|---|---|
| macOS AppKit selector / menu item sender routing for split / merge-backward intents | closed as mechanism floor | `53 §4.1` |
| product menu command system | open / not run | `53 §5` |
| product focus lifecycle across real windows / scroll views / split views | open / not run | `51 §5`, `53 §5` |
| product responder-chain undo suppression | open / not run | `53 §5` |
| UIKit / `UITextView` menu / keyboard / view lifecycle / IME / accessibility runtime | open / not run | `53 §4.2`, `53 §5` |
| real `anchor-core::dispatch` integration for keyboard/menu intents and patches | open / not run | `49 §5`, `50 §5`, `51 §5`, `52 §5`, `53 §5` |
| product accessibility mapping | open / not run | `52 §5`, `53 §5` |
| VoiceOver / Accessibility Inspector runtime | open / not run | `52 §5`, `53 §5` |
| polished cross-block continuous native text selection | open / not run | `52 §5`, `53 §5` |
| product AppKit view hierarchy integration | open / not run | `50 §5`, `53 §5` |
| external volume | open / not run | `46 §6` |
| security-scoped bookmark restoration | open / not run | `46 §6` |
| Finder move UI surface | open / not run | `46 §6` |
| `.icloud` placeholder classification | open / not run | `46 §6` |
...
## 44. Progress ledger update — 2026-06-10 — TextKit responder undo suppression

本节追加 `54-textkit-responder-undo-suppression-report.md` 的 ledger 状态。`21` 的原始 CP-1 synthesis 结论仍成立：CP-1 core side complete；Apple half 仍 release / delivery gated；CP-1 whole-exit 未退出。

### 44.1 Axis matrix after doc 54

| Axis | Verdict |
|---|---|
| core deterministic（groups 1+5） | **go**（unchanged） |
| multi-target compile | **go**（unchanged） |
| zero-cloud-symbol boundary | **go**（unchanged after doc 54 audit） |
| binding（B4） | **approved boundary / partially release-gated** — unchanged after doc 53 |
| TextKit（group 3 runtime） | **partial mechanism floor closed** — macOS AppKit responder-chain `undo:` suppression into adapter-owned semantic undo closed; product undo grouping / inverse-op dispatch, UIKit runtime, product focus lifecycle, and dispatch integration remain open |
| iCloud Drive（B14） | **approved default transport WITH compromise constraints** — unchanged after doc 53 |
| layout / retention | **compromise** — unchanged after doc 53 |
| cross-target execution CI | **hosted native/wasm/iOS-sim closed; Android execution open** — unchanged after doc 53 |
| **CP-1 whole-exit** | **未退出 (NOT exited)** |

### 44.2 Open-gate checklist after doc 54

| Gate | Status | Evidence pointer |
|---|---|---|
| macOS AppKit responder-chain `undo:` suppression into adapter-owned semantic undo | closed as mechanism floor | `54 §4.1` |
| product undo grouping / inverse-op dispatch | open / not run | `54 §5` |
| UIKit / `UITextView` responder-chain undo runtime | open / not run | `54 §4.2`, `54 §5` |
| product menu command system | open / not run | `53 §5`, `54 §5` |
| product focus lifecycle across real windows / scroll views / split views | open / not run | `51 §5`, `53 §5`, `54 §5` |
| UIKit / `UITextView` menu / keyboard / view lifecycle / IME / accessibility runtime | open / not run | `53 §4.2`, `53 §5`, `54 §5` |
| real `anchor-core::dispatch` integration for keyboard/menu/undo intents and patches | open / not run | `49 §5`, `50 §5`, `51 §5`, `52 §5`, `53 §5`, `54 §5` |
| product accessibility mapping | open / not run | `52 §5`, `53 §5`, `54 §5` |
| VoiceOver / Accessibility Inspector runtime | open / not run | `52 §5`, `53 §5`, `54 §5` |
| polished cross-block continuous native text selection | open / not run | `52 §5`, `53 §5`, `54 §5` |
| product AppKit view hierarchy integration | open / not run | `50 §5`, `53 §5`, `54 §5` |
| external volume | open / not run | `46 §6` |
| security-scoped bookmark restoration | open / not run | `46 §6` |
| Finder move UI surface | open / not run | `46 §6` |
| `.icloud` placeholder classification | open / not run | `46 §6` |
...
## 46. Progress ledger update — 2026-06-10 — UIKit TextView runtime

本节追加 `56-uikit-textview-runtime-report.md` 的 ledger 状态。`21` 的原始 CP-1 synthesis 结论仍成立：CP-1 core side complete；Apple half 仍 release / delivery gated；CP-1 whole-exit 未退出。

### 46.1 Axis matrix after doc 56

| Axis | Verdict |
|---|---|
| core deterministic（groups 1+5） | **go**（unchanged） |
| multi-target compile | **go**（unchanged） |
| zero-cloud-symbol boundary | **go**（unchanged after doc 56 audit） |
| binding（B4） | **approved boundary / partially release-gated** — unchanged after doc 55 |
| TextKit（group 3 runtime） | **partial mechanism floor closed** — iOS Simulator `UITextView` runtime floor for selection / marked text / `UIKeyInput` intent capture / scroll-hosted identity+labels closed; product app-hosted UIKit responder/focus/menu/undo, VoiceOver/UI runtime, and dispatch integration remain open |
| iCloud Drive（B14） | **approved default transport WITH compromise constraints** — unchanged after doc 55 |
| layout / retention | **compromise** — unchanged after doc 55 |
| cross-target execution CI | **hosted native/wasm/iOS-sim closed; Android execution open** — unchanged after doc 55 |
| **CP-1 whole-exit** | **未退出 (NOT exited)** |

### 46.2 Open-gate checklist after doc 56

| Gate | Status | Evidence pointer |
|---|---|---|
| iOS Simulator `UITextView` UTF-16 selection / marked text / `UIKeyInput` split-merge capture / scroll-hosted identity+labels | closed as mechanism floor | `56 §4.3` |
| product app-hosted UIKit focus/window lifecycle | open / not run | `56 §5` |
| UIKit menu command system | open / not run | `56 §5` |
| UIKit responder-chain undo grouping / inverse-op dispatch | open / not run | `56 §5` |
| VoiceOver / Accessibility Inspector runtime | open / not run | `56 §5` |
| full product focus lifecycle across document windows / tabs / sheets / sidebars / restored scroll state | open / not run | `55 §5`, `56 §5` |
| product AppKit view hierarchy integration | open / not run | `50 §5`, `53 §5`, `54 §5`, `55 §5`, `56 §5` |
| product undo grouping / inverse-op dispatch | open / not run | `54 §5`, `55 §5`, `56 §5` |
| product menu command system | open / not run | `53 §5`, `54 §5`, `55 §5`, `56 §5` |
| real `anchor-core::dispatch` integration for keyboard/menu/undo/focus intents and patches | open / not run | `49 §5`, `50 §5`, `51 §5`, `52 §5`, `53 §5`, `54 §5`, `55 §5`, `56 §5` |
| product accessibility mapping | open / not run | `52 §5`, `53 §5`, `54 §5`, `55 §5`, `56 §5` |
| polished cross-block continuous native text selection | open / not run | `52 §5`, `53 §5`, `54 §5`, `55 §5`, `56 §5` |
| external volume | open / not run | `46 §6` |
| security-scoped bookmark restoration | open / not run | `46 §6` |
| Finder move UI surface | open / not run | `46 §6` |
| `.icloud` placeholder classification | open / not run | `46 §6` |
...
## 48. Progress ledger update — 2026-06-10 — UIKit menu command routing

本节追加 `58-uikit-menu-command-routing-report.md` 的 ledger 状态。`21` 的原始 CP-1 synthesis 结论仍成立：CP-1 core side complete；Apple half 仍 release / delivery gated；CP-1 whole-exit 未退出。

### 48.1 Axis matrix after doc 58

| Axis | Verdict |
|---|---|
| core deterministic（groups 1+5） | **go**（unchanged） |
| multi-target compile | **go**（unchanged） |
| zero-cloud-symbol boundary | **go**（unchanged after doc 58 audit） |
| binding（B4） | **approved boundary / partially release-gated** — unchanged after doc 57 |
| TextKit（group 3 runtime） | **partial mechanism floor closed** — iOS Simulator `UIKeyCommand` + `UITextView` target-action menu-command routing closed as mechanism floor; product app-hosted UIKit menu system, responder-chain undo, VoiceOver/UI runtime, and dispatch integration remain open |
| iCloud Drive（B14） | **approved default transport WITH compromise constraints** — unchanged after doc 57 |
| layout / retention | **compromise** — unchanged after doc 57 |
| cross-target execution CI | **hosted native/wasm/iOS-sim closed; Android execution open** — unchanged after doc 57 |
| **CP-1 whole-exit** | **未退出 (NOT exited)** |

### 48.2 Open-gate checklist after doc 58

| Gate | Status | Evidence pointer |
|---|---|---|
| iOS Simulator `UIKeyCommand` target-action routing to split / merge-backward intents | closed as mechanism floor | `58 §4.3` |
| product app-hosted UIKit menu command system | open / not run | `58 §5` |
| `UIApplication` / scene / window command installation | open / not run | `58 §5` |
| UIKit responder-chain undo grouping / inverse-op dispatch | open / not run | `56 §5`, `57 §5`, `58 §5` |
| product app-hosted UIKit patch replay across real document windows / tabs / sheets / restored scroll state | open / not run | `57 §5`, `58 §5` |
| product app-hosted UIKit focus/window lifecycle | open / not run | `56 §5`, `57 §5`, `58 §5` |
| VoiceOver / Accessibility Inspector runtime | open / not run | `56 §5`, `57 §5`, `58 §5` |
| full product focus lifecycle across document windows / tabs / sheets / sidebars / restored scroll state | open / not run | `55 §5`, `56 §5`, `57 §5`, `58 §5` |
| product AppKit view hierarchy integration | open / not run | `50 §5`, `53 §5`, `54 §5`, `55 §5`, `56 §5`, `57 §5`, `58 §5` |
| product undo grouping / inverse-op dispatch | open / not run | `54 §5`, `55 §5`, `56 §5`, `57 §5`, `58 §5` |
| product menu command system | open / not run | `53 §5`, `54 §5`, `55 §5`, `56 §5`, `57 §5`, `58 §5` |
| real `anchor-core::dispatch` integration for keyboard/menu/undo/focus intents and patches | open / not run | `49 §5`, `50 §5`, `51 §5`, `52 §5`, `53 §5`, `54 §5`, `55 §5`, `56 §5`, `57 §5`, `58 §5` |
| product accessibility mapping | open / not run | `52 §5`, `53 §5`, `54 §5`, `55 §5`, `56 §5`, `57 §5`, `58 §5` |
| polished cross-block continuous native text selection | open / not run | `52 §5`, `53 §5`, `54 §5`, `55 §5`, `56 §5`, `57 §5`, `58 §5` |
| external volume | open / not run | `46 §6` |
| security-scoped bookmark restoration | open / not run | `46 §6` |
| Finder move UI surface | open / not run | `46 §6` |
| `.icloud` placeholder classification | open / not run | `46 §6` |
...
## 49. Progress ledger update — 2026-06-10 — UIKit responder undo

本节追加 `59-uikit-responder-undo-report.md` 的 ledger 状态。`21` 的原始 CP-1 synthesis 结论仍成立：CP-1 core side complete；Apple half 仍 release / delivery gated；CP-1 whole-exit 未退出。

### 49.1 Axis matrix after doc 59

| Axis | Verdict |
|---|---|
| core deterministic（groups 1+5） | **go**（unchanged） |
| multi-target compile | **go**（unchanged） |
| zero-cloud-symbol boundary | **go**（unchanged after doc 59 audit） |
| binding（B4） | **approved boundary / partially release-gated** — unchanged after doc 58 |
| TextKit（group 3 runtime） | **partial mechanism floor closed** — iOS Simulator `UITextView` responder target-action undo routing to adapter-owned grouped semantic undo closed as mechanism floor; product app-hosted UIKit responder chain, cross-window undo grouping, VoiceOver/UI runtime, and dispatch integration remain open |
| iCloud Drive（B14） | **approved default transport WITH compromise constraints** — unchanged after doc 58 |
| layout / retention | **compromise** — unchanged after doc 58 |
| cross-target execution CI | **hosted native/wasm/iOS-sim closed; Android execution open** — unchanged after doc 58 |
| **CP-1 whole-exit** | **未退出 (NOT exited)** |

### 49.2 Open-gate checklist after doc 59

| Gate | Status | Evidence pointer |
|---|---|---|
| iOS Simulator `UITextView` responder target-action undo routing to adapter-owned grouped semantic undo | closed as mechanism floor | `59 §4.3` |
...
## 57. Progress ledger update — 2026-06-10 — iOS Simulator iCloud support rerun

本节追加 `67-ios-simulator-icloud-support-rerun-report.md` 的 ledger 状态。`21` 的原始 CP-1 synthesis 结论仍成立：CP-1 core side complete；Apple half 仍 release / delivery gated；CP-1 whole-exit 未退出。

### 57.1 Axis matrix after doc 67

| Axis | Verdict |
|---|---|
| core deterministic（groups 1+5） | **go** — unchanged after doc 67 |
| multi-target compile | **go** — unchanged after doc 67 |
| zero-cloud-symbol boundary | **go** — unchanged after doc 67 |
| binding（B4） | **approved boundary / partially release-gated** — unchanged after doc 67 |
| TextKit（group 3 runtime） | **partial mechanism floor closed** — unchanged after doc 67 |
| iCloud Drive（B14） | **approved default transport WITH compromise constraints** — iOS 26.5 Simulator rerun still returns nil ubiquity containers and `BRCloudDocsErrorDomain:153`; physical iOS runtime remains open |
| layout / retention | **compromise** — unchanged after doc 67 |
| cross-target execution CI | **closed as hosted machine gate** — unchanged after doc 67 |
| **CP-1 whole-exit** | **未退出 (NOT exited)** |

### 57.2 Open-gate checklist after doc 67

| Gate | Status | Evidence pointer |
|---|---|---|
| iOS Simulator project/scheme/defaults | closed / observed | `67 §3.1`-`§3.3` |
| Xcode-managed iOS Simulator build/install/launch | closed / observed | `67 §3.3`-`§3.4` |
| simulated CloudDocuments entitlement surface | observed | `67 §3.3` |
| iOS Simulator CloudDocuments runtime support | **open / failed in current runtime** | `67 §3.4`-`§3.5`: `explicit_nil=true`, `implicit_nil=true`, `BRCloudDocsErrorDomain:153` |
