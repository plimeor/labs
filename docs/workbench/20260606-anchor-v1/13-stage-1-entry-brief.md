...
- `./17-apple-binding-report.md`、`18-textkit-adapter-report.md`、`19-icloud-drive-report.md`、`15-core-evidence.md`、`14-core-spike-report.md`（Stage 1 实测证据）。
...
- spike 组 4 保留 iCloud runtime evidence matrix：signed container、package UTType、metadata behavior、file coordination、offline conflict materialization、placeholder/account/scale gates。已跑项与开放项见 `19-icloud-drive-report.md`。
