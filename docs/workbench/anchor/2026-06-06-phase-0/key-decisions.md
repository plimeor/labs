...
- **Status**：Needs Stage 1 policy / delivery gate（signed macOS 10K/50K/100K direct enumeration observed；remote placeholder、iOS large-scale delivery、steady-state segment budget 留 Stage 1）
